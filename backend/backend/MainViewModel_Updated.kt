...
class MainViewModel : ViewModel() {
    ...
    // ===== Loading States =====
    var isFetchingMails: Boolean by mutableStateOf(false)
    ...
    private fun loadSampleMails() {
        mails = listOf(
            Mail("1", "Admin", "System Update", "Today", "Important system maintenance scheduled"),
            Mail("2", "Support", "Your Booking Confirmed", "Yesterday", "Booking ID: #4 has been confirmed"),
            Mail("3", "Manager", "Weekly Report", "2 days ago", "Please review the attached report")
        )
    }
...
enum class CmsScreen(val title: String, val icon: androidx.compose.material.icons.Icons) {
    ...
    Bookings("Bookings", androidx.compose.material.icons.Icons.Default.EventNote),
    Mails("Mails", androidx.compose.material.icons.Icons.Default.Email),
